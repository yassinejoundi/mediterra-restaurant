    ...
    <section className="bg-plaster px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-32">
      <div className="mx-auto grid max-w-screen-2xl overflow-hidden rounded-[2rem] bg-linen lg:grid-cols-2">
        <ScrollReveal className="flex flex-col justify-between p-7 sm:p-10 lg:p-14" direction="right">
          <div>
            <p className="mb-4 font-label text-xs font-semibold uppercase tracking-[0.22em] text-wine">Find your way to the table</p>
            ...
            <p className="mt-6 max-w-lg text-pretty font-body text-base leading-7 text-espresso/70">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl bg-plaster p-5">
              ...
              <p className="mt-2 font-body text-sm leading-6 text-espresso/70">Evening tables by reservation</p>
            </div>
            <div className="rounded-2xl bg-plaster p-5">
              ...
              <p className="mt-2 font-body text-sm leading-6 text-espresso/70">Requests confirmed by our team</p>
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal className="relative min-h-[28rem] overflow-hidden bg-olive p-7 text-plaster sm:p-10 lg:p-14" direction="left" delay={0.08}>
          ...
          <div className="relative flex h-full min-h-[24rem] flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-5 max-w-sm font-body text-sm leading-6 text-white">
                Contact our host team for location guidance and help planning your arrival.
              </p>
              <Link
                href="/contact"
                className="mt-8 inline-flex min-h-12 items-center gap-3 rounded-full bg-plaster px-7 py-3 font-label text-sm font-semibold text-espresso transition-colors hover:bg-espresso hover:text-plaster focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-plaster"
              >
                Contact &amp; Directions
