...
export function AtmosphereGrid() {
  return (
    <>
      ...
      <div className="md:col-span-7 editorial-image-container rounded-2xl overflow-hidden shadow-soft h-[500px]">
      <Image alt="Courtyard dining at dusk" className="editorial-image w-full h-full object-cover" src={courtyardDiningImage} />
      </div>
      <div className="md:col-span-5 grid grid-rows-2 gap-6 md:gap-8 h-[500px]">
